...
func RegFrontRouteRouter(r *gin.Engine) {
	...
	r.Handle("GET", "/front_route/list", func() func(ctx *gin.Context) {
	...
	r.Handle("GET", "/front_route/get/:id", func(ctx *gin.Context) {
		id, _ := strconv.Atoi(ctx.Param("id"))
		result, code, err := ctrl.Get(ctx, id)
		egin.Response(ctx, result, code, err)
	}, middleware.IpLimiter())

	r.Handle("POST", "/front_route/create", func() func(ctx *gin.Context) {
		return func(ctx *gin.Context) {
	...
	r.Handle("POST", "/front_route/update/:id", func() func(ctx *gin.Context) {
		return func(ctx *gin.Context) {
			var params controller.FrontRouteForm
			errs := utils.Validated(ctx, &params)
			if errs != nil {
	...
	r.Handle("DELETE", "/front_route/delete:id", func(ctx *gin.Context) {
		id, _ := strconv.Atoi(ctx.Param("id"))
		result, code, err := ctrl.Delete(ctx, id)
		egin.Response(ctx, result, code, err)
	})

	r.Handle("GET", "/front_route/tree", func(ctx *gin.Context) {
