...
var file_hello_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x64, 0x65, 0x22, 0x20, 0x0a, 0x0a, 0x42, 0x79, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x38, 0x0a, 0x08, 0x42, 0x79, 0x65, 0x52, 0x65, 0x70,
	...
	0x6c, 0x6f, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x32,
	0x37, 0x0a, 0x03, 0x42, 0x79, 0x65, 0x12, 0x30, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c,
	0x6c, 0x6f, 0x12, 0x11, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x42, 0x79, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x42, 0x79,
...
var file_hello_proto_depIdxs = []int32{
	...
	2, // 1: hello.Bye.SayHello:input_type -> hello.ByeRequest
	1, // 2: hello.Hello.SayHello:output_type -> hello.HelloReply
	3, // 3: hello.Bye.SayHello:output_type -> hello.ByeReply
...
type ByeClient interface {
	SayHello(ctx context.Context, in *ByeRequest, opts ...grpc.CallOption) (*ByeReply, error)
}
...
func (c *byeClient) SayHello(ctx context.Context, in *ByeRequest, opts ...grpc.CallOption) (*ByeReply, error) {
	out := new(ByeReply)
	err := c.cc.Invoke(ctx, "/hello.Bye/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ByeServer interface {
	SayHello(context.Context, *ByeRequest) (*ByeReply, error)
}
...
func (*UnimplementedByeServer) SayHello(context.Context, *ByeRequest) (*ByeReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHello not implemented")
}
...
func _Bye_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ByeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ByeServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.Bye/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ByeServer).SayHello(ctx, req.(*ByeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Bye_serviceDesc = grpc.ServiceDesc{
	ServiceName: "hello.Bye",
	HandlerType: (*ByeServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHello",
			Handler:    _Bye_SayHello_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "hello.proto",
